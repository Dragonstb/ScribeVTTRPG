/* This file is from the library 'stompjs', v7.0.0 we use in ScribeVTTRPG for the WebSockets on the client side. See
 *
 *      https://github.com/stomp-js/stompjs/tree/7.0.0
 *
 * stompjs is distributed under Apache-2.0 license. Besides adding this header for credits and licence, we have not
 * modified anything in the code.
 *
 * ----------------------------------------------------------------------------------------
 *
 *  Apache License
